...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO reservaciones (nombre, apellido, telefono, habitacion, fecha_entrada, fecha_salida,) 
            VALUES ('$nombre', '$apellido', '$telefono', '$habitacion', '$fecha_entrada', '$fecha_salida')";
